...
# Set up logging
logging.basicConfig(filename="./result/vct2_video_similarity_log.txt", level=logging.INFO, format="%(message)s")
...
def evaluate_all_videos_in_directory(directory):
    ...
    with open("./result/vct2_similarities.csv", mode="w", newline="") as csv_file:
...
directory = "/storage/home/mingzhe/code/VideoCrafter/results_t2v/base_512_v2"
