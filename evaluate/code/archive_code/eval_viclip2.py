...
for i, item in enumerate(data):
    video_path = f"/storage/home/mingzhe/code/VideoGen-of-Thought/thirdparty/i2v-module-3/DynamiCrafter/results/VGoT/dynamicrafter_vgot_mary_life2_1024_mp_seed123/samples_separate/sample_ip_{i}_sample0.mp4"
    prompt = item['prompt']
    ...
    print(f"Aspect scores: {aspect_scores}")
    ...
    print(f"Frame-to-frame similarity score: {frame2frame_similarity}")
...
results_df.to_csv('./result/retrieval_similarity_scores.csv', index=False)
