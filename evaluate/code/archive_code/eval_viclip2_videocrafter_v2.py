...
for i, item in enumerate(data):
    video_path = f"/storage/home/mingzhe/code/VideoCrafter/results_t2v/base_512_v2/{str(i+1).zfill(4)}.mp4"
    prompt = item['prompt']
...
results_df.to_csv('./result/videocrafter_v2.csv', index=False)
