...
for i, item in enumerate(data):
    video_path = f"/storage/home/mingzhe/code/VideoCrafter/results_t2v_v1/base_512_v1/{str(i+1).zfill(4)}.mp4"
    prompt = item['prompt']
...
results_df.to_csv('./result/videocrafter_v1.csv', index=False)
